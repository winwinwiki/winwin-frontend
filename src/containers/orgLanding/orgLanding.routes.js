...
const OrgLandingRoutes = (props) => (
    <OrgLanding history={props.history} match={props.match}>
        <Switch>
            ...
            <CrumbRoute title={"New Organization"} exact path="/organizations/new" component={CreateOrg} />
            <CrumbRoute title={"Upload Data Feed"} exact path="/organizations/uploadDataFeed" component={UploadDataFeed} />
            {/* <CrumbRoute title={"Organization Details"} path="/organizations/:id/programs/:programId" component={ProgramDetailRoutes} /> */}
            <CrumbRoute title={"Organization Details"} path="/organizations/:id" component={OrgDetailRoutes} />
        </Switch>
    </OrgLanding>
)
