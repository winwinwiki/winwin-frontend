...
class ResetPassword extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (nextProps && nextProps.resetPassword !== resetPassword && nextProps.resetPassword.data) {
    ...
    render() {
        let { confirmPassword, password, formError } = this.state;
        ...
        return (
            <div className="w-100 flex-fill d-flex flex-column justify-content-center">
                ...
                <div className="form-group w-100 mb-4 login-form-group">
                    ...
                    {formError.confirmPassword ? <div>{formError.confirmPassword}</div> : <div>&nbsp;</div>}
                </div>
