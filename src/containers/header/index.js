    ...
    <div className="container"><a href="#" className="navbar-brand"><img src="../images/winwin-logo-white.svg" alt="WinWin logo" height="30" className="mb-2"/></a>
        ...
        <div>
            <ul className="navbar-nav">
                <li className="nav-item dropdown"><a href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" className="nav-link dropdown-toggle active">John Smith<img src="../images/profile-pic.png" alt="Profile Pic" width="30" className="mb-2 mx-2"/></a>
